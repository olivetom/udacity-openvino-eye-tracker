...
class HeadPoseEstimationModel:
    ...
    def preprocess_output(self, outputs, image, face, facebox, print_flag=True, threshold=0.5):
        ...
        if print_flag:
            cv2.putText(image,f"y:{yaw:.1f}", (20,20), 0, 0.6, (255,255,0))
            cv2.putText(image,f"p:{pitch:.1f}", (20,40), 0, 0.6, (255,255,0))
            cv2.putText(image,f"r:{roll:.1f}", (20,60), 0, 0.6, (255,255,0))
    ...
    # source: https://knowledge.udacity.com/questions/171017
